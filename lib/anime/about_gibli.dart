...
class AboutGibli extends StatelessWidget {
  const AboutGibli({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('About'),
        backgroundColor: Color.fromARGB(255, 76, 137, 85),
        leading: IconButton(
          onPressed: () {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10.0),
                        Text(
                          'Ghibli Park is a park facility that expresses the world of Studio Ghibli works, with five areas scattered throughout the vast Expo Memorial Park (Moricoro Park).',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 16.0,
                          ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10.0),
                        Text(
                          'Website: The Studio Gibli Collection',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 16.0,
                          ),
